...
export default function PortafolioPage() {
  ...
  const categories = [
    ...
    {
      id: 57,
      title: "Cajoneras con Rieles Telescópicos",
      category: "muebles",
      location: "Santiago",
      date: "Julio 2024",
      description:
        "Detalle técnico de herrajes e instalación de rieles telescópicos reforzados de alta calidad en cajoneras a medida.",
      image: "/images/detalle-cajonera-rieles-1.jpeg",
      gallery: [
        "/images/detalle-cajonera-rieles-1.jpeg",
        "/images/detalle-cajonera-rieles-2.jpeg"
      ],
      features: ["Rieles telescópicos", "Deslizamiento suave", "Gran capacidad de carga", "Acero zincado"],
    },
    {
      id: 58,
      title: "Sistemas de Despensa Extraíble",
      category: "cocinas",
      location: "Santiago",
      date: "Julio 2024",
      description:
        "Módulos de despensa extraíble cromados instalados a medida en columnas de cocina, optimizando el acceso y almacenamiento.",
      image: "/images/detalle-despensa-extraible-1.jpeg",
      gallery: [
        "/images/detalle-despensa-extraible-1.jpeg",
        "/images/detalle-despensa-extraible-2.jpeg"
      ],
      features: ["Canastillos cromados", "Extracción total", "Cierre amortiguado", "Ajuste de altura"],
    },
    {
      id: 59,
      title: "Sistemas de Iluminación LED Integrados",
      category: "muebles",
      location: "Santiago",
      date: "Julio 2024",
      description:
        "Detalles de iluminación LED indirecta empotrada en perfiles de aluminio para gabinetes aéreos, estanterías y clósets.",
      image: "/images/detalle-cocina-led-1.jpeg",
      gallery: [
        "/images/detalle-cocina-led-1.jpeg",
        "/images/detalle-cocina-led-2.jpeg"
      ],
      features: ["Perfiles de aluminio", "Difusor opalino", "Luz cálida 3000K", "Encendido por sensor"],
    },
    {
      id: 60,
      title: "Instalación y Ajustes en Terreno",
      category: "muebles",
      location: "Santiago",
      date: "Julio 2024",
      description:
        "Fotografías del proceso de montaje, nivelación e instalación en terreno realizado por nuestro equipo especializado de maestros carpinteros.",
      ...
      features: ["Nivelación milimétrica", "Ajuste a muros", "Anclajes estructurales", "Terminaciones finas"],
    },
  ]
